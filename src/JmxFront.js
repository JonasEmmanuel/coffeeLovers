  ...
  return (
    <div className='card'>
      ...
      <div className='card-body'>
        <Col sm={10}>
          <Label for='VerbeHttp'><b>Verbe HTTP:</b></Label>
          <Select
            options={options}
            onChange={props.onChangeSelect}
            value={props.verbeHttp ? props.verbeHttp : ''}
          />
          <Label for='Endpoint'><b>Url:</b></Label>
        ...
        {props.myparams.map((p, i) => {
          return (
            <Col sm={10}>
              ...
              <Label>
                <b>{props.allparams[p].nom}({props.allparams[p].ptype}):</b>
              </Label>
              <Input
                type='text'
              ...
              />
              <Label><i>Required: {props.allparams[p].nullable}</i></Label>
            </Col>
          )
        })}
        <Col sm={10}>
      ...
      <div className='card-footer'>
        <ButtonGroup>
          <Button outline color='success'>Executer Requete</Button>
          <div id='right'>
            <Button
              outline
              color='danger'
